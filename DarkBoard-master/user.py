...
class User(UserMixin):
    ...
    ::return Boolean, Is (not) an admin
    '''
    def isAdmin(self):
        return self.id >= 10000000 and self.id < 20000000

    '''
    Checks if the user is a Teacher
    ::return Boolean, Is (not) a teacher
    '''
    def isTeacher(self):
        return self.id >= 70000000 and self.id < 80000000

    '''
    Checks if the user is a Student
    ::return Boolean, Is (not) a Student
    '''
    def isStudent(self):
        return self.id >= 90000000 and self.id < 100000000